    ...
    printComments(comments, target, hidden = false) {
        ...
        comments.forEach(child => {
            ...
            if (child.children.length > 0) {
                ...
                button.classList.add('ml-2', 'inline-block', 'rounded-md', 'px-1', 'py-1', 'text-sm', 'focus:relative', 'text-gray-500', 'hover:text-gray-700', 'dark:text-gray-400', 'dark:hover:text-gray-200', 'focus:text-white', 'bg-gray-200', 'dark:bg-gray-800')
